...
```
cd existing_repo
git remote add origin https://gitlab.com/kayrayildiz1/oop3-assignment-723073.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/kayrayildiz1/oop3-assignment-723073/-/settings/integrations)
